define(['jquery','knockout', 'text!./ConceptPickerTemplate.html', './InputTypes/Concept', 'services/Vocabulary', 'assets/knockout-jqueryui/dialog', 'less!./conceptpicker.less'], function ($, ko, template, Concept, VocabularyProvider) {
